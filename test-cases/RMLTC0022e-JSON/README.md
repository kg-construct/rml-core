...
**Title**: "Generating of triples with datatypeMap with custom datatype with referenced-valued datatypeMap"

**Description**: "Test triples with a custom referenced-valued datatypeMap from the data"
