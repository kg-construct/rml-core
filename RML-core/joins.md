...
## 8.1 Referencing Subject Map

A [Referencing Subject Map] (`rml:ReferencingSubjectMap`) is represented by a resource that:
...
The [Referencing Object Map]() (`rml:ReferencingObjectMap`) can be
